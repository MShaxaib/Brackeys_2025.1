...
Shader "Hidden/STS_alpha_mask_RT_ortho" {
	...
	SubShader
	{
		...
		{ 
			...
			//	origDepth = SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture, UNITY_PROJ_COORD(i.scrPos)).r * (_ProjectionParams.z - _ProjectionParams.y)  + _ProjectionParams.y;
			//else
			//	origDepth = _ProjectionParams.y + (1.0 - SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture, UNITY_PROJ_COORD(i.scrPos)).r)  *  (_ProjectionParams.z - _ProjectionParams.y);						
